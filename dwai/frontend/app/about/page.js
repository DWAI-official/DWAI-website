...
const SAMPLE_TEAM = [
  ...
  { id: 8, name: "Evan Nwuche", position: "Financial Officer", image: "/assets/teams/evan.jpg" },
  { id: 9, name: "Jane Ameh", position: "Assistant Finance Officer", image: "/assets/teams/jane.jpg" },
  { id: 10, name: "Dinatu Yahaya", position: "Procurement Officer", image: "/assets/teams/dinatu.jpg" },
  
];

// Sample Mission & Vision
const MISSION = { title: "Our Mission", text: "To empower Deaf Women and girls to access sexual and reproductive health and rights (SRHR) services for an inclusive society.", image: "/assets/images/outreach6.jpg" };
      ...
      <section className="py-20 bg-pink-200">
        ...
        <div className="max-w-7xl mx-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 px-6">
          {SAMPLE_TEAM.map((member) => (
            <motion.div key={member.id} className="bg-white border-2 border-purple-500 rounded-3xl ounded-3xl shadow-md hover:shadow-xl p-6 text-center" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
